...
const styles = StyleSheet.create({
  ...
  orderTitle: { ...typography.subtitle, color: colors.textPrimary },
  footer: { flexDirection: "row", justifyContent: "space-between" },
  status: { ...typography.caption, color: colors.textSecondary },
  price: { ...typography.caption, color: colors.textPrimary },
  unlocked: { ...typography.caption, color: colors.success },
  reviewHint: { ...typography.caption, color: colors.primary },
});
